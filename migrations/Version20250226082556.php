 ...
 */
final class Version20250226082556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE metasiniciativas (id INT AUTO_INCREMENT NOT NULL, cod_iniciativa_id INT NOT NULL, id_metas_id INT NOT NULL, INDEX IDX_E6045A769FF9454 (cod_iniciativa_id), INDEX IDX_E6045A7673F2E7AE (id_metas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
