 ...
 */
final class Version20250328105632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE modulo (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE modulo_clase (id INT AUTO_INCREMENT NOT NULL, modulo_id INT DEFAULT NULL, clase_id INT DEFAULT NULL, INDEX IDX_B4E383EEC07F55F5 (modulo_id), INDEX IDX_B4E383EE9F720353 (clase_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE modulo_clase ADD CONSTRAINT FK_B4E383EEC07F55F5 FOREIGN KEY (modulo_id) REFERENCES modulo (id)');
        $this->addSql('ALTER TABLE modulo_clase ADD CONSTRAINT FK_B4E383EE9F720353 FOREIGN KEY (clase_id) REFERENCES clase (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE modulo_clase DROP FOREIGN KEY FK_B4E383EEC07F55F5');
        $this->addSql('ALTER TABLE modulo_clase DROP FOREIGN KEY FK_B4E383EE9F720353');
        ...
        $this->addSql('DROP TABLE modulo_clase');
