...
class PROFESORES
{
     ...
     */
    #[ORM\OneToMany(targetEntity: PROFESORESMODULOS::class, mappedBy: 'profesor')]
    ...
    public function addModulo(PROFESORESMODULOS $modulo): static
    {
    ...
    public function removeModulo(PROFESORESMODULOS $modulo): static
    {
